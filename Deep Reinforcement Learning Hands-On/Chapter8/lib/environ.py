...
class StocksEnv(gym.Env):
    ...
    def __init__(self, prices, bars_count=DEFAULT_BARS_COUNT, commission=DEFAULT_COMISSION_PERC,
    ...
    def reset(self):
        # make selection of the instruments and it's offset. Then reset the state
