...
class I2A(nn.Module):
    ...
    def rollouts_batch(self, batch):
        ...
        for step_idx in range(self.rollout_steps):
            ...
            # dont need actions for the last step
...
class RolloutEncoder(nn.Module):
    def __init__(self, input_shape, hidden_size=ROLLOUT_HIDDEN):
        ...
        self.rnn = nn.LSTM(input_shape=conv_out_size + 1, hidden_size=hidden_size, batch_first=False)
